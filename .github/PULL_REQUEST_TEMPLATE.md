...
**Important:** The maintainer adopted an [individual non-exclusive CLA v1.1](../CONTRIBUTOR_LICENSE_AGREEMENT.md) covering AGPL and separately licensed commercial/proprietary YourHand editions. **External signing is not yet independently verified:** the [narrow-permission GitHub PR-comment consent workflow](../docs/CLA_SCOPED_SIGNING.md) is being activated; the hosted CLA Assistant OAuth was declined because it requested access beyond this public repository. A PR checkbox is not signing. External contributions must not be merged until the authenticated signer check is operational, the correct legal rights holder has accepted the agreement, and employment/third-party ownership has been reviewed. An employee may need separate corporate permission. The agreement has not been independently certified by a lawyer; consult [current signing status](../docs/CLA_SIGNING_SETUP.md).
