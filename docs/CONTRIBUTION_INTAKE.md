...
2. Before merging an external PR, verify a finalized, accepted CLA signed by all relevant copyright owners; record signer, legal name or entity, GitHub account, agreement version, timestamp and PR/commit references in a restricted access record. Do not post signatures or private personal information in a public repository.
