...
| Contributor licensing | Owner adopted non-exclusive individual CLA v1.1; activate hosted acceptance workflow, review corporate-owned rights and obtain targeted legal advice if necessary | [Unsigned/signed signer test and branch check](CLA_SIGNING_SETUP.md) before any external code merge |
