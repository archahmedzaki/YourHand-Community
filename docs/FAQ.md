...
Only after the applicable rights holder executes a finalized non-exclusive CLA or another valid, specific separate license that grants the necessary rights. The [CLA draft](../CONTRIBUTOR_LICENSE_AGREEMENT.md) is **not yet an effective agreement**; external code merge intake is on hold. See [CLA FAQ](CLA_FAQ.md).
